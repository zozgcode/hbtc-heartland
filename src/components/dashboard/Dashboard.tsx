    ...
    <div className="">
      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          <div className="border flex flex-col gap-6 bg-[#007769] text-white p-4 rounded-lg">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="p-[5px_20px] rounded-full bg-white text-[#007769] text-[14px]"
              >
                Send money
              </Link>
            </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link
              ...
              className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#007769] rounded-full"
            >
