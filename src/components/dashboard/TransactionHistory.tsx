    ...
    <div className="px-[16px]">
      <div className="w-full">
        <div className="text-[14px] w-full font-[500] flex items-center justify-between">
          ...
          <Link href="/dashboard/transactions" className="text-[13px] font-[500] text-[#007769]">See All</Link>
        </div>
        <div className="mt-[10px]">
          {transactionsToShow.map((transaction: Transaction) => (
            <div key={transaction.transaction_id} className="flex justify-between py-3">
              ...
              <button className="border-none flex items-center justify-center outline-none rounded-full w-[35px] h-[35px] bg-[#007769]/10"><HiArrowDown className={`${transaction.amount_usd < 0 ? "rotate-180" : ""}`} /></button>
